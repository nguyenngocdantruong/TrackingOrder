...
const translations = {
    vi: {
        ...
        'landing.hero.subtitle': 'Giải pháp Hub tập trung giúp bạn quản lý tất cả kiện hàng với thông báo qua ',
        'landing.hero.subtitle.prefix': 'Giải pháp theo dõi đơn hàng tập trung giúp bạn quản lý tất cả kiện hàng của đơn vị',
        'landing.hero.subtitle.suffix': 'với thông báo tức thì qua ',
        ...
        'settings.zalo.chat_id_notice.prefix': 'Vui lòng chat với bot để lấy chat id cho Zalo. Mở bot tại',
        'settings.zalo.chat_id_notice.link': 'BOT',
    ...
    en: {
        ...
        'landing.hero.subtitle': 'Centralized Hub solution helps you manage all packages with instant notifications via ',
        'landing.hero.subtitle.prefix': 'Centralized order-tracking solution helps you manage all parcels from',
        'landing.hero.subtitle.suffix': 'with instant notifications via ',
        ...
        'settings.zalo.chat_id_notice.prefix': 'Please chat with the bot to obtain the Zalo chat id. Open the bot at',
        'settings.zalo.chat_id_notice.link': 'BOT',
